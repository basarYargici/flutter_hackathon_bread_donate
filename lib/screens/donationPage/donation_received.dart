  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          elevation: 0,
          leading: IconButton(
            icon: Icon(Icons.keyboard_arrow_left_sharp,color: Colors.black45,size: getProportionateScreenHeight(45),),
            onPressed: () {
        ...
        SizedBox(
            child: Text('TEŞEKKÜRLER',
                style: onboardingTitleStyle.copyWith(
                    fontFamily: 'PTSherifRegular', fontSize: getProportionateScreenWidth(30), fontWeight: FontWeight.bold))),
      ],
    );
  }
}
